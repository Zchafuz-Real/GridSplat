...
@dataclass
class GridsplatModelConfig(ModelConfig):
    """Gridsplat Model Config, nerfstudio's implementation of Gaussian Splatting"""

    _target: Type = field(default_factory=lambda: GridsplatModel)
...
class GridsplatModel(Model):
    ...
    Args:
        config: Gridsplat configuration to instantiate model
    """

    config: GridsplatModelConfig
